//Kartenlayer definieren
        ...
        gpxbike.bindPopup(
        '<h4>Bike-Track Tirol</h4><a href=biketrack.html>Seite</a>');
        gpxtrack.bindPopup(
        '<h4>Wanderweg KAT</h4><a href=wandertrack.html>Seite</a>');
      ...
      // leaflet-hash aktivieren
		...
		L.marker([47.35663, 12.27387], { title: "Wander-Etappe", icon: hike}).addTo(map);
		...
		L.marker([47.364963, 11.159393], { title: "Rad-Etappe", icon: bike}).addTo(map);       
